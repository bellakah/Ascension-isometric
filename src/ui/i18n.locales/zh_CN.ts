...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Ascension 官方网站',
  'seo.officialBody':
  ...
  'wallet.standaloneAppHelp':
    '主屏幕应用暂不支持连接钱包。若要使用 Phantom 或 Solflare，请在 Safari 或 Chrome 中打开 Ascension。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '批准后请从主屏幕返回 Ascension。如果 iOS 打开了浏览器，请将其关闭并重新打开主屏幕应用。',
  ...
  'wallet.browser.safety': 'Ascension 绝不会索要助记词或私钥。',
  ...
  'wallet.browser.completeBody': '现在可以返回 Ascension 桌面应用。',
  ...
  'playerCard.shareText':
    '我正在 Ascension 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'Ascension：经典风格网页 MMO',
  'seo.description':
    '在 Ascension 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 Ascension 的 GitHub 项目',
  'a11y.discordCommunity': '加入 Ascension 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 Ascension',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 Ascension。',
  ...
  'guide.worldPage.intro': 'Ascension 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。这里没有快速旅行，没有飞行路线，也没有马车：每一段路程都靠步行或骑乘完成，所以抵达本身就是冒险的一部分。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。',
  ...
  'hudChrome.nativeUpdate.body':
    'Ascension 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Ascension {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.notify.updateReadyBody': '重启 Ascension 以应用更新。',
  ...
  'desktop.crash.fatalBody': 'Ascension 遇到意外错误，需要关闭。',
  ...
  'editor.docTitle': '地图编辑器 - Ascension',
  ...
  'hudChrome.wocMarket.browserOnlyConfirmBody':
    '$WOC 交易所仅在 Ascension 的浏览器版本中提供。即将在浏览器中打开 Ascension，你可以在那里登录并打开交易所，游戏会继续在这里运行。',
  ...
  'hudChrome.steam.wishlistAria': '在 Steam 上加入愿望单：打开 Ascension 商店页面',
  ...
  'hudChrome.wiki.confirmBody': '将在浏览器中打开 Ascension 维基，游戏会继续运行。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'Ascension 性能诊断',
  ...
  'hudChrome.perf.diagnostics.report.title': 'Ascension 性能诊断',
