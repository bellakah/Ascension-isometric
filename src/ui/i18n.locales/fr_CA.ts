...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.title': 'Ascension: MMO Web de style classique',
  'seo.description':
    'Lancez-vous dans une aventure épique dans Ascension, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un monde partagé et persistant, faites monter vos classes en niveau et terrassez vos ennemis.',
