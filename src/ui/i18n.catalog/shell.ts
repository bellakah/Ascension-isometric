...
export const shellStrings = {
  en: {
    seo: {
      ...
      officialLabel: 'Official Ascension game',
      officialBody:
        'Ascension is an isometric online RPG currently in active development. This fork preserves the proven Ascension technical foundation while its public identity, art, maps, audio, and game content are replaced progressively.',
    },
    a11y: {
      ...
      githubProject: 'Open the Ascension GitHub project',
      discordCommunity: 'Join the Ascension Discord community',
      donateProject: 'Donate to support Ascension',
    },
    entryGuard: {
    ...
    desktop: {
      ...
      notify: {
        ...
        updateReadyBody: 'Restart Ascension to apply the update.',
      ...
      crash: {
        ...
        reload: 'Reload',
        quit: 'Quit',
        fatalBody: 'Ascension hit an unexpected error and needs to close.',
      },
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Open Ascension from the new Home Screen icon.',
      ...
      androidOpenStep: 'Open Ascension from the new icon.',
    ...
    serverUnavailable: {
      title: 'Ascension - World Unavailable',
      logoAlt: 'Ascension',
  ...
  es: {
    seo: {
      title: 'Ascension: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en Ascension, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto de Ascension en GitHub',
      discordCommunity: 'Unirse a la comunidad de Ascension en Discord',
      donateProject: 'Donar para apoyar Ascension',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abre Ascension desde el nuevo icono de la pantalla de inicio.',
      ...
      androidOpenStep: 'Abre Ascension desde el nuevo icono.',
    ...
    serverUnavailable: {
      title: 'Ascension - Reino no disponible',
      logoAlt: 'Ascension',
  ...
  es_ES: {
    seo: {
      title: 'Ascension: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en Ascension, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
      genre: 'MMORPG',
      playMode: 'Multijugador',
      applicationCategory: 'Juego',
      operatingSystem: 'Navegador web',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto Ascension en GitHub',
      discordCommunity: 'Unirse a la comunidad de Ascension en Discord',
      donateProject: 'Donar para apoyar Ascension',
    },
    loading: {
  ...
  fr_FR: {
    seo: {
      title: 'Ascension: MMO web de style classique',
      description:
        'Partez pour une aventure épique dans Ascension, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Ouvrir le projet Ascension sur GitHub',
      discordCommunity: 'Rejoindre la communauté Ascension sur Discord',
      donateProject: 'Faire un don pour soutenir Ascension',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez Ascension depuis la nouvelle icône de l'écran d'accueil.",
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Ouvrez Ascension depuis la nouvelle icône.',
    ...
    serverUnavailable: {
      title: 'Ascension - Royaume indisponible',
      logoAlt: 'Ascension',
  ...
  fr_CA: {
    seo: {
      title: 'Ascension: MMO Web de style classique',
      description:
        "Partez à l'aventure dans Ascension, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: 'MMORPG',
      playMode: 'Multijoueur',
      applicationCategory: 'Jeu',
      operatingSystem: 'Navigateur Web',
  ...
  en_CA: {
    seo: {
      title: 'Ascension',
      description:
        'Embark on an epic adventure in Ascension, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
    ...
    serverUnavailable: {
      title: 'Ascension - Realm Unavailable',
      logoAlt: 'Ascension',
  ...
  it_IT: {
    seo: {
      title: 'Ascension: MMO web in stile classico',
      description:
        "Parti per un'avventura epica in Ascension, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Apri il progetto Ascension su GitHub',
      discordCommunity: 'Entra nella community Discord di Ascension',
      donateProject: 'Fai una donazione per sostenere Ascension',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Apri Ascension dalla nuova icona nella schermata Home.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Apri Ascension dalla nuova icona.',
    ...
    serverUnavailable: {
      title: 'Ascension - Reame non disponibile',
      logoAlt: 'Ascension',
  ...
  de_DE: {
    seo: {
      title: 'Ascension: Klassisches Web-MMO',
      description:
        'Begib dich in Ascension auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Ascension-Projekt auf GitHub öffnen',
      discordCommunity: 'Der Ascension-Community auf Discord beitreten',
      donateProject: 'Spenden, um Ascension zu unterstützen',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Öffne Ascension über das neue Symbol auf dem Home-Bildschirm.',
      ...
      androidOpenStep: 'Öffne Ascension über das neue Symbol.',
    ...
    serverUnavailable: {
      title: 'Ascension - Realm nicht verfügbar',
      logoAlt: 'Ascension',
  ...
  zh_CN: {
    seo: {
      title: 'Ascension：经典风格网页 MMO',
      description:
        '在 Ascension 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
      genre: 'MMORPG',
      playMode: '多人游戏',
    ...
    a11y: {
      ...
      githubProject: '打开 Ascension 的 GitHub 项目',
      discordCommunity: '加入 Ascension 的 Discord 社区',
      donateProject: '捐赠支持 Ascension',
    },
    loading: {
      world: '正在加载世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '从新的主屏幕图标打开 Ascension。',
  ...
  zh_TW: {
    seo: {
      title: 'Ascension：經典風格網頁 MMO',
      description:
        '在 Ascension 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
      genre: 'MMORPG',
      playMode: '多人遊戲',
    ...
    a11y: {
      ...
      characterActions: '角色操作',
      githubProject: '開啟 Ascension 的 GitHub 專案',
      discordCommunity: '加入 Ascension 的 Discord 社群',
      donateProject: '捐贈支持 Ascension',
    },
    loading: {
      world: '正在載入世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '從新的主畫面圖示開啟 Ascension。',
  ...
  ko_KR: {
    seo: {
      title: 'Ascension: 클래식 스타일 웹 MMO',
      description:
        '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Ascension에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
      genre: 'MMORPG',
      playMode: '멀티플레이어',
    ...
    a11y: {
      ...
      githubProject: 'GitHub에서 Ascension 프로젝트 열기',
      discordCommunity: 'Ascension Discord 커뮤니티 참여',
      donateProject: 'Ascension 후원하기',
    },
    loading: {
      world: '세계 불러오는 중...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '새 홈 화면 아이콘에서 Ascension를 여세요.',
  ...
  ja_JP: {
    seo: {
      title: 'Ascension: クラシック風Web MMO',
      description:
        'ブラウザで直接遊べるクラシック風マイクロMMO、Ascension で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。',
      genre: 'MMORPG',
      playMode: 'マルチプレイヤー',
    ...
    a11y: {
      ...
      githubProject: 'GitHubでAscensionプロジェクトを開く',
      discordCommunity: 'AscensionのDiscordコミュニティに参加',
      donateProject: 'Ascensionを支援するために寄付',
    },
    loading: {
      world: '世界を読み込み中...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '新しいホーム画面アイコンからAscensionを開きます。',
  ...
  pt_BR: {
    seo: {
      title: 'Ascension: MMO web em estilo clássico',
      description:
        'Embarque em uma aventura épica em Ascension, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir o projeto Ascension no GitHub',
      discordCommunity: 'Entrar na comunidade Ascension no Discord',
      donateProject: 'Doar para apoiar Ascension',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abra Ascension pelo novo ícone na tela inicial.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Abra Ascension pelo novo ícone.',
    ...
    serverUnavailable: {
      title: 'Ascension - Reino indisponível',
      logoAlt: 'Ascension',
  ...
  ru_RU: {
    seo: {
      title: 'Ascension: веб-MMO в классическом стиле',
      description:
        'Отправьтесь в эпическое приключение в Ascension, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Открыть проект Ascension на GitHub',
      discordCommunity: 'Присоединиться к Discord-сообществу Ascension',
      donateProject: 'Пожертвовать на поддержку Ascension',
    },
    loading: {
      world: 'Загрузка мира...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Откройте Ascension через новый значок на домашнем экране.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Откройте Ascension через новый значок.',
    ...
    serverUnavailable: {
      title: 'Ascension - мир недоступен',
      logoAlt: 'Ascension',
