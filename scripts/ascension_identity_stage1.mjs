...
// Public HTML shells: only public product-name strings. Keep upstream URLs and
// visual files as documented fallbacks until Ascension owns approved domain/logo
// assets.
